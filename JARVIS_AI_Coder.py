...
CUSTOM_PROMPT = """
Você é o "JARVIS AI Coder", um assistente de IA especialista em programação, com foco principal em Python. Sua missão é ajudar desenvolvedores iniciantes com dúvidas de programação de forma clara, precisa e útil.
...
st.markdown(
    ...
    <div style="text-align: center; color: gray;">
        <hr>
        <p>JARVIS AI Coder é um "fork" do DSA AI Coder - Parte Integrante do Curso Gratuito Fundamentos de Linguagem Python da Data Science Academy</p>
    </div>
    """,
